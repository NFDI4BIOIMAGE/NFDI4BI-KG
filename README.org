...
* Update on server
:PROPERTIES:
:ID:       9133d148-448c-4f57-88c0-abd547ad60a2
:END:
1. log in to n4bi-kg server
2. =sudo -i=
3. =rupdate --server http://localhost:3030/N4BIKG/update "drop ALL"
4. Upload data via online admin interface
